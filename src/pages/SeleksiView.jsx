...
const SeleksiView = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      // Validasi 1: Cek ukuran file (Maksimal 2MB = 2 * 1024 * 1024 bytes)
      const maxSize = 2 * 1024 * 1024;
      
      if (file.size > maxSize) {
        setFileError('Gagal: Ukuran file melebihi batas maksimal 2MB!');
        setSelectedFile(null); // Reset file jika kebesaran
  ...
  return (
    <div className="py-12 bg-slate-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 md:p-10 mb-8">
            ...
            <form className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* BAGIAN YANG DIUBAH: Pilihan Rentang Tanggal (Date Picker) */}
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input 
                      type="date" 
                      value={endDate}
                      min={startDate} // Tanggal akhir tidak boleh mendahului tanggal mulai
              ...
              <div>
                ...
                <label className={`block border-2 ${fileError ? 'border-red-400 bg-red-50' : selectedFile ? 'border-emerald-400 bg-emerald-50' : 'border-dashed border-slate-300 hover:bg-slate-50'} rounded-lg p-8 text-center transition-colors cursor-pointer`}>
                  ...
                  {/* Input asli disembunyikan menggunakan tailwind 'hidden' */}
                  <input 
                    type="file" 
                    accept=".pdf" 
                    className="hidden" 
                  ...
                  {/* Kondisi Tampilan: Jika File Sukses Diunggah */}
                  {selectedFile ? (
                    <div>
                    ...
                    /* Kondisi Tampilan: Status Default / Belum ada file */
                    <div>
                ...
                {/* Pesan Error jika file lebih dari 2MB */}
                {fileError && (
        ...
        {/* Tabel Kuota untuk mengecek sisa slot */}
        <QuotaTable />
      </div>
    </div>
  );
